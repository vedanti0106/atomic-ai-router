...
const Header: React.FC<HeaderProps> = ({ onMenuClick }) => {
  ...
  return (
    <header className="h-[68px] bg-white border-b border-line flex items-center justify-between px-4 sm:px-6 md:px-8 sticky top-0 z-30 shadow-xs">
      ...
      {/* Right section: Notifications + User Profile (AI Router pill removed) */}
      <div className="flex items-center gap-3 sm:gap-5 flex-shrink-0">
        ...
        <div className="flex items-center gap-2.5 cursor-pointer hover:opacity-80 transition-opacity">
          <div className="w-9 h-9 rounded-full bg-navy flex items-center justify-center text-white font-bold text-sm flex-shrink-0 shadow-xs">
            V
          </div>
